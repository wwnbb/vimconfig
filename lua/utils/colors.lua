...
M.colorscheme = {
	colors_dark = {
		...
		background_light = colors_base.base02,

		base03 = colors_base.base03,
		base02 = colors_base.base02,
		base01 = colors_base.base01,
		base00 = colors_base.base00,
		base0 = colors_base.base0,
		base1 = colors_base.base1,
		base2 = colors_base.base2,
		base3 = colors_base.base3,
		yellow = colors_base.yellow,
		orange = colors_base.orange,
		red = colors_base.red,
		dark_red = colors_base.dark_red,
	...
	colors_light = {
		...
		background_light = colors_base.base2,
