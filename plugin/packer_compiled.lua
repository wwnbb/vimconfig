...
_G.packer_plugins = {
  ...
  NeoSolarized = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/NeoSolarized",
  ...
  ["cmp-nvim-ultisnips"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/cmp-nvim-ultisnips",
  ...
  ["dressing.nvim"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/dressing.nvim",
  ...
  ["git-conflict.nvim"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/git-conflict.nvim",
  ...
  ["inc-rename.nvim"] = {
    ...
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/inc-rename.nvim",
  ...
  ["mini.nvim"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/mini.nvim",
    url = "https://github.com/echasnovski/mini.nvim"
  },
  neogen = {
    config = { "\27LJ\2\n8\0\0\3\0\3\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0004\2\0\0B\0\2\1K\0\1\0\nsetup\vneogen\frequire\0" },
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/neogen",
    url = "https://github.com/danymat/neogen"
  },
  ["neosnippet-snippets"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/neosnippet-snippets",
    url = "https://github.com/Shougo/neosnippet-snippets"
  },
  neotest = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/neotest",
    url = "https://github.com/nvim-neotest/neotest"
  },
  ["neotest-go"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/neotest-go",
    url = "https://github.com/nvim-neotest/neotest-go"
  },
  ["neotest-python"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/neotest-python",
  ...
  ["nvim-dap-go"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/nvim-dap-go",
    url = "https://github.com/leoluz/nvim-dap-go"
  },
  ["nvim-dap-python"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/nvim-dap-python",
  ...
  ["nvim-dap-virtual-text"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/nvim-dap-virtual-text",
  ...
  ["tailwind-classes-fold"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/tailwind-classes-fold",
    url = "https://github.com/wwnbb/tailwind-classes-fold"
  },
  ["tailwindcss-colorizer-cmp.nvim"] = {
    ...
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/tailwindcss-colorizer-cmp.nvim",
    url = "https://github.com/roobert/tailwindcss-colorizer-cmp.nvim"
  },
  ["telescope-dap.nvim"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/telescope-dap.nvim",
  ...
  ["telescope-github.nvim"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/telescope-github.nvim",
    url = "https://github.com/nvim-telescope/telescope-github.nvim"
  },
  ["telescope-makefile"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/telescope-makefile",
    url = "https://github.com/sopa0/telescope-makefile"
  },
  ["telescope.nvim"] = {
    config = { "\27LJ\2\nx\0\0\4\0\a\0\0166\0\0\0'\2\1\0B\0\2\0029\1\2\0'\3\3\0B\1\2\0019\1\2\0'\3\4\0B\1\2\0019\1\2\0'\3\5\0B\1\2\0019\1\2\0'\3\6\0B\1\2\1K\0\1\0\agh\bdap\tmake\bfzf\19load_extension\14telescope\frequire\0" },
    loaded = true,
  ...
  ["tmuxline.vim"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/tmuxline.vim",
  ...
  ultisnips = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/ultisnips",
    url = "https://github.com/SirVer/ultisnips"
  },
  ["vim-airline"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/vim-airline",
    url = "https://github.com/vim-airline/vim-airline"
  },
  ["vim-airline-themes"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/vim-airline-themes",
    url = "https://github.com/vim-airline/vim-airline-themes"
  },
  ["vim-caddyfile"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/vim-caddyfile",
    url = "https://github.com/isobit/vim-caddyfile"
  },
  ["vim-flog"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/vim-flog",
